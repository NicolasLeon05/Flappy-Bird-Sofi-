...
#pragma region TITLE_TEXTS
	...
	titlePart1 = Text::GetText(screenWidth/2, 0, Text::Fonts::Title1, static_cast<int>(Text::FontSize::big), "PLANET", MAGENTA);
	Text::CenterTextX(titlePart1);
	titlePart1.location.y = static_cast<float>(Text::Padding::medium);
	titlePart2 = Text::GetText(screenWidth / 2, titlePart1.location.y + Text::GetTextHeight(titlePart1), Text::Fonts::Title2, static_cast<int>(Text::FontSize::giant), "DESTROYER", YELLOW);
